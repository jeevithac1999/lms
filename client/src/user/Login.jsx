             ...
             <Col className="col-8">
               <Card>
                ...
                <form>
                  ...
                  <div className="text-center">
                    <p><a href="/register/student" className="grey-text font-small ml-1"> Register as a student.</a><a href="/register/teacher" className="grey-text font-small ml-1"> Register as a faculty.</a></p>
                  </div>
                </form>
              </CardBody>
            </Card>
